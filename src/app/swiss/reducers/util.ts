...
function calculatePlayerWinData(players: Player[], standings: Dictionary<Standing>) {
  const minimum = 1 / 3;
...
function getStandingsList(players: Player[], standings: Dictionary<Standing>): Standing[] {
