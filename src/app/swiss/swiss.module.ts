...
import { PairingEffects, PlayerEffects, RoundEffects, TournamentEffects } from 'app/swiss/effects';
...
@NgModule({
  imports: [
    EffectsModule.forFeature([PairingEffects, PlayerEffects, RoundEffects, TournamentEffects]),
    SharedModule,
